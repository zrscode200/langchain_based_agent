...
export default function App() {
  ...
  function executeCommand(command: ComposerCommand) {
    ...
    switch (command.action) {
      case 'model': if (args) setModel(args); setModal('conversation-settings'); break;
